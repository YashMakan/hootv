...
class MediaInfoRepositoryImpl extends MediaInfoRepository {
  ...
  @override
  Future<Either<ErrorState, TvShowInfoModel>> fetchTvShowInfo(int tvShowId) async {
    return await ErrorHandler.callApi(
  ...
  @override
  Future<Either<ErrorState, List<YouTubeVideoModel>>> fetchMovieVideos(int movieId) async {
    return await ErrorHandler.callApi(
  ...
  @override
  Future<Either<ErrorState, List<YouTubeVideoModel>>> fetchTvShowVideos(int tvShowId) async {
    return await ErrorHandler.callApi(
  ...
  @override
  Future<Either<ErrorState, List<CreditsModel>>> fetchMovieCredits(int movieId) async {
    return await ErrorHandler.callApi(
  ...
  @override
  Future<Either<ErrorState, List<CreditsModel>>> fetchTvShowCredits(int tvShowId) async {
    return await ErrorHandler.callApi(
